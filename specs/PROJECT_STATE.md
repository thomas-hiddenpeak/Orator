...
- **Last updated**: 2026-07-03 (mic/live hardening: silent-input ASR hallucination suppression, ASR chunk cap 12 s, comprehensive Live segmentation fix, GPU telemetry device metrics surfaced)
- **Branch**: `master`
- **Constitution**: v1.4.0
