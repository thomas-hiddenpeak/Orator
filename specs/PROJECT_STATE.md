...
alter the source partitions and evidence used by FR50 and would require a new
full constitutional reading. Capture and structural tools may arrange raw
evidence and verify mechanical contracts only; no executable result may
evaluate correctness, aggregate accuracy, rank a repair, or issue a product
verdict.
