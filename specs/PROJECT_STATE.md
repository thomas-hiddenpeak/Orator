...
- **Last updated**: 2026-07-01 (Spec 006 Web UI Phase 2 rebuild: modular ES client — full WS coverage, global speaker identity, forced-alignment lane, live observability panel; data layer validated on real telemetry)
- **Branch**: `master`
- **Constitution**: v1.4.0
