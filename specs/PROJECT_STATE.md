...
- **Last updated**: 2026-07-19 (T111/T123/T133 speaker ledgers reconciled)
- **Branch**: `master`
- **Constitution**: v1.7.0
...
| Revisable comprehensive timeline (Spec 004) | T111 is the best frozen comparison; FR29/FR30 rejected; closure open | `ComprehensiveTimeline` stores typed diarization, ASR, VAD, alignment, voiceprint, and business tracks and publishes immutable snapshots/typed updates. Its VAD snapshot includes observed, active, and confirmed-silence frontiers used by scheduling-invariant ASR gating. `BusinessSpeakerPipeline` consumes typed `SpeakerEvidenceStage` output and owns orchestration/publication; the internal `SpeakerFusionPolicy` owns rule execution. T135's uniform complete-context reconciliation records T111 at `514/556`, FR29/T123 at `505/556`, and FR30/T133 at `497/556`. T111 still fails one fixed block, 朱杰 recall, critical attribution, and confident-wrong attribution; FR29 and FR30 remain rejected. FR16ABO's historical `518/556` predates the uniform reconciliation and is not used for ranking. Checked-in VAD threshold is restored to `0.5`. Speaker-time, ASR, and independent holdout remain open. |
...
- [specs/013-industrial-closing-validation/spec.md](013-industrial-closing-validation/spec.md) - **T135 reconciled the full T111/T123/T133 natural-turn ledgers; FR16ABO, both FR28 600-second promotions, FR29 full T123, and FR30 full T133/T134 remain rejected; T102/T084 remain open**. Complete forward/reverse contextual review now records T111 at `514/556`, T123 at `505/556`, and T133 at `497/556`. T111 is the best frozen comparison but fails the 3000-3600 block, 朱杰 recall, critical attribution, and confident-wrong attribution. FR16ABO's historical `518/556` predates the uniform reconciliation and is not used for ranking. Commit `d610de36ed13` closes T112 mechanically without changing speaker behavior. Checked-in `vad.threshold` is restored to `0.5`. Speaker-time, per-speaker time, source-time-offset, ASR, browser/microphone, holdout, report-review, and release-tag gates remain open.
