...
- [specs/013-industrial-closing-validation/spec.md](013-industrial-closing-validation/spec.md) - **FR16ABN natural-turn baseline and T112 telemetry cadence passed; FR16ABO, both FR28 600-second promotions, and FR29 full T123 promotion rejected; T102/T084 remain open**. Transitional commit `6b1cb79fa4f5` remains the accepted `519/556` natural-turn baseline after complete 556-contribution forward/reverse contextual review; fixed-block and per-speaker turn recall pass, while critical-speaker and confident-wrong attribution fail. Commit `d610de36ed13` closes T112 without changing speaker behavior. FR16ABO commit `f49a8278e0d8` passed its mechanical ladder but was rejected after both full paths were manually reviewed at `518/556`; its TOML switch is disabled. FR28 removes the later-proven VAD/ASR scheduling race, and commit `7579bc25411c` passes blank and repeated 120-second gates, but its complete 600-second review still fails `ref-0073`. FR29 commit `2ce4a12b7973` passes the repeated 120-second and complete 600-second gates, but clean T123 commit `2ff9ce3655b2a12e90a5d0def25c0a30f171f2d9` is rejected after complete independent full A/B review at `506/556`; two fixed blocks, two canonical speakers, critical attribution, and confident-wrong attribution fail. Speaker-time, per-speaker time, source-time-offset, ASR, browser/microphone, holdout, report-review, and release-tag gates remain open.
