...
- **Last updated**: 2026-07-19 (FR32 full promotion reviewed; bounded repair retained)
- **Branch**: `master`
- **Constitution**: v1.7.0
...
- [specs/013-industrial-closing-validation/spec.md](013-industrial-closing-validation/spec.md) - **T135 reconciled the full T111/T123/T133 natural-turn ledgers; FR16ABO, both FR28 600-second promotions, FR29 full T123, FR30 full T133/T134, and FR31 remain rejected; FR32 completes full real-WebSocket promotion as a bounded repair but does not close the speaker business; T102/T084 remain open**. Complete forward/reverse contextual review records T111 at `514/556`, T123 at `505/556`, and T133 at `497/556` before FR32. T142's independent full FR32 paths each record `506/556` after complete chronological and reverse-block contextual review. FR32 repairs only `ref-0154`; two fixed blocks, 朱杰 recall, critical attribution, and confident-wrong attribution still fail. Commit `d610de36ed13` closes T112 mechanically without changing speaker behavior. Checked-in `vad.threshold` is `0.5`. Speaker-time, per-speaker time, source-time-offset, ASR, browser/microphone, holdout, report-review, and release-tag gates remain open.
...
T136-T142 are complete. FR31 is rejected after deterministic frozen replay and
...
T143 next specifies a source-free partition-invariant abstention candidate on
frozen evidence; T144 may implement and replay it only before another audio run.
