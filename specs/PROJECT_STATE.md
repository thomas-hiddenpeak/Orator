...
- [specs/013-industrial-closing-validation/spec.md](013-industrial-closing-validation/spec.md) - **T135 reconciled the full T111/T123/T133 natural-turn ledgers; FR16ABO, both FR28 600-second promotions, FR29 full T123, FR30 full T133/T134, and FR31 remain rejected; FR32 completes full real-WebSocket promotion and FR33 completes frozen review as bounded repairs, but neither closes the speaker business; T102/T084 remain open**. Complete forward/reverse contextual review records T111 at `514/556`, T123 at `505/556`, and T133 at `497/556` before FR32. T142's independent full FR32 paths each record `506/556`. FR33 repairs frozen `ref-0517` and gives a manually reconciled frozen candidate of `507/556`, with no new real-path claim. Two fixed blocks, 朱杰 recall, critical attribution, and confident-wrong attribution still fail. Commit `d610de36ed13` closes T112 mechanically without changing speaker behavior. Checked-in `vad.threshold` is `0.5`. Speaker-time, per-speaker time, source-time-offset, ASR, browser/microphone, holdout, report-review, and release-tag gates remain open.
