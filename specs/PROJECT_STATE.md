...
- **Last updated**: 2026-07-10 (Spec 012 speaker-support diagnostics were full-length WebSocket evaluated. The fields are stable and useful for exposing weak ownership evidence, but they are not an accepted speaker-accuracy recovery; tail attribution remains below closing-grade.)
- **Branch**: `master`
- **Constitution**: v1.5.0
