...
- **Last updated**: 2026-07-10 (Spec 012 speaker-support diagnostics were full-length WebSocket evaluated, then extended with an explicit `speaker_uncertain` business-view field. This is a safety/visibility improvement, not an accepted speaker-accuracy recovery; tail attribution remains below closing-grade.)
- **Branch**: `master`
- **Constitution**: v1.5.0
