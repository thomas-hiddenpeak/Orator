...
- **Last updated**: 2026-07-08 (Spec 012 speaker drift + runtime comprehensive fusion recovery validated on a full 3615 s real WebSocket run; known speaker-business regression windows are materially recovered, with residual short-boundary artifacts and conservative unknown spans)
- **Branch**: `master`
- **Constitution**: v1.5.0
