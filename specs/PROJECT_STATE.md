...
| Test suite | 75 configured CTest entries | The active Sortformer gates are bound to v2.1. Focused C++ tests cover typed speaker evidence, capture-ordered speaker-identity replay input, ASR full-context Final PCM/replacement/retraction, embedding-cache lifecycle, bounded precompute, final draining, accepted production fusion/abstention policy, and monotonic telemetry deadlines; active Python tests cover ASR oracle provenance, source/time/config invariants, immutable raw tracks, WebSocket manifests, telemetry, evidence integrity, replay inputs, and unjudged review packets. Thirty-three historical candidate tests are archived outside CTest. The current full CTest run passes all `75/75` entries in `53.95 s`; the final build emits no warning or error diagnostic. Browser and physical-microphone acceptance remain outside CTest. No automated result may assign correctness, aggregate accuracy, rank/select a candidate, or produce product acceptance. |
...
- [specs/014-asr-vad-closing/spec.md](014-asr-vad-closing/spec.md) - **Baseline and Live publication correction complete through 600 seconds; Chromium file flow and bounded room tone reviewed; final-ASR causal trace complete and first prompt candidate rejected; ASR semantics and voiced microphone remain open (2026-08-09)**. This focused spec freezes FR50 speaker behavior while establishing full contextual ASR, VAD endpoint, Live/Final, microphone, and browser evidence. The current full baseline has complete chronological and reverse contextual review of all 556 contributions. Commit `a1c8d1d` removes unchanged direct partial publication without changing final product tracks and passes warning-clean build, `74/74` tests, three directly reviewed silence sessions, repeated 120-second, 360-second, and 600-second real-WebSocket gates. Commits `b0eadbe` and `d09b13b` correct browser persistence and source-clock pacing; the clean 120-second Chromium flow passes complete mechanical and contextual review. A real physical-endpoint room-tone session at `d2ac5d1` has no substantive speech assertion, but the only board analog source cannot currently deliver controlled speech, so active microphone scenarios remain open. Complete direct rereading and a common-clock trace of `text_id=133` isolate one prompt-conditioned decoder factor: `语音识别` appears in Live and final ASR before alignment and matches the configured system prompt. Clean commit `5accc5f` then tests an empty-system-prompt TOML candidate in the complete 102-second surrounding context. Both repeated legal terms remain unusable, while `雷总` becomes `伟哥` and the neighboring option-pool discussion materially regresses. The candidate is rejected and removed before silence or 120-second gates; the pre-candidate prompt is restored, with a warning-clean build and `74/74` CTest pass. Every product conclusion is directly reviewed; ASR remains below closing requirements and the conditional FR50 speaker boundary remains unchanged. See [full-baseline-context-review-2026-08-09.md](014-asr-vad-closing/full-baseline-context-review-2026-08-09.md), [live-partial-publication-review-2026-08-09.md](014-asr-vad-closing/live-partial-publication-review-2026-08-09.md), [browser-persistence-review-2026-08-09.md](014-asr-vad-closing/browser-persistence-review-2026-08-09.md), [physical-microphone-review-2026-08-09.md](014-asr-vad-closing/physical-microphone-review-2026-08-09.md), and [final-asr-prompt-causality-review-2026-08-09.md](014-asr-vad-closing/final-asr-prompt-causality-review-2026-08-09.md). Raw artifacts remain under gitignored `artifacts/spec014/`.
