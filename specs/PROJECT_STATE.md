...
- [specs/014-asr-vad-closing/spec.md](014-asr-vad-closing/spec.md) - **Baseline and Live publication correction complete through 600 seconds; Chromium file flow and bounded room tone reviewed; final-ASR causal trace and experimental TOML candidate complete; ASR semantics and voiced microphone remain open (2026-08-09)**. This focused spec freezes FR50 speaker behavior while establishing full contextual ASR, VAD endpoint, Live/Final, microphone, and browser evidence. The current full baseline has complete chronological and reverse contextual review of all 556 contributions. Commit `a1c8d1d` removes unchanged direct partial publication without changing final product tracks and passes warning-clean build, `74/74` tests, three directly reviewed silence sessions, repeated 120-second, 360-second, and 600-second real-WebSocket gates. Commits `b0eadbe` and `d09b13b` correct browser persistence and source-clock pacing; the clean 120-second Chromium flow passes complete mechanical and contextual review. A real physical-endpoint room-tone session at `d2ac5d1` has no substantive speech assertion, but the only board analog source cannot currently deliver controlled speech, so active microphone scenarios remain open. Complete direct rereading and a common-clock trace of `text_id=133` now isolate one prompt-conditioned decoder defect: `语音识别` appears in Live and final ASR before alignment and matches the configured system prompt. The empty-system-prompt TOML candidate is now active as a one-variable experiment; its config test, warning-clean build, and `74/74` CTest pass, but no product gate accepts it yet. Every product conclusion is directly reviewed; ASR remains below closing requirements and the conditional FR50 speaker boundary remains unchanged. See [full-baseline-context-review-2026-08-09.md](014-asr-vad-closing/full-baseline-context-review-2026-08-09.md), [live-partial-publication-review-2026-08-09.md](014-asr-vad-closing/live-partial-publication-review-2026-08-09.md), [browser-persistence-review-2026-08-09.md](014-asr-vad-closing/browser-persistence-review-2026-08-09.md), [physical-microphone-review-2026-08-09.md](014-asr-vad-closing/physical-microphone-review-2026-08-09.md), and [final-asr-prompt-causality-review-2026-08-09.md](014-asr-vad-closing/final-asr-prompt-causality-review-2026-08-09.md). Raw artifacts remain under gitignored `artifacts/spec014/`.
...
Resume Spec 014 Phase 3 with candidate `asr-empty-system-prompt`. T045/T046 have
completed the full contextual reread and common-clock trace: the selected legal
term failure is already present in decoder Live/final text and is only preserved
by alignment and the business view. Implement only the empty TOML system prompt
and its configuration-contract test, preserving every other ASR/VAD, FR50, and
model value. Then run the focused legal-context excerpt, three silence sessions,
and two complete 120-second reviews before 360/600-second gates or any full run.
