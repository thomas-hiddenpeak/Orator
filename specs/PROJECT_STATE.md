...
- **Last updated**: 2026-07-09 (Spec 012 tail evidence review added frame-level diar probing; 3270-3304 s remains a bottom-diarization hard spot, and reset/silence-profile/low-coverage/gap-fill candidates are not accepted fixes)
- **Branch**: `master`
- **Constitution**: v1.5.0
...
- **Spec 012 speaker-business recovery — current active line** (2026-07-08).
  ...
  evidence, not Web UI rendering or business-turn serialization.
