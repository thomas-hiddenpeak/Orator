...
- **Last updated**: 2026-07-19 (FR43 frozen candidate retained; closure open)
- **Branch**: `master`
- **Constitution**: v1.7.0
...
`75/80`. This is also not a new real-WebSocket run; critical and confident-
wrong attribution, speaker-time sign-off, repeatability, and holdout gates
remain open.
