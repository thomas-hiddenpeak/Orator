...
- **Last updated**: 2026-07-10 (Spec 012 speaker-support diagnostics were full-length WebSocket evaluated, then extended with an explicit `speaker_uncertain` business-view field. Follow-up diar tail TOML experiments, NeMo full-length reference check, and TitaNet tail voiceprint review found no accepted low-cost tail attribution recovery; tail speaker-business attribution remains below closing-grade.)
- **Branch**: `master`
- **Constitution**: v1.5.0
