...
- **Last updated**: 2026-06-30 (Spec 011 observability Phase 2: comprehensive rerun dashboard — continuous hardware telemetry, cursor backlog, scheduler health, blueprint, methodology; fixed nested [telemetry.cursor] config bug; validated rate=1 120 s)
- **Branch**: `master`
- **Constitution**: v1.4.0
